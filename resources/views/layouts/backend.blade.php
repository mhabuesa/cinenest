...
<head>
    ...
    <title>CineNest – Online Movies Website </title>
    <!-- Favicon -->
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item
        ...
        {{$title == 'pendingList'?'open':''}}
        {{$title == 'rejectedList'?'open':''}}
    ">
      ...
      <ul class="menu-sub">
        ...
        @can('movie_list')
        <li class="menu-item {{$url == '/movie_list'?'active':''}} {{$title == 'movie_edit'?'active':''}}">
        ...
        @can('pending_list')
        <li class="menu-item {{$url == '/pendingList'?'active':''}} ">
            <a href="{{route('pending.list')}}" class="menu-link">
                <div data-i18n="Pending List">Pending List</div>
            </a>
        </li>
        @endcan

        @can('reject_list')
        <li class="menu-item {{$url == '/rejectedList'?'active':''}}">
            <a href="{{route('rejected.list')}}" class="menu-link">
                <div data-i18n="Rejected List">Rejected List</div>
            </a>
        </li>
        @endcan
    ...
    <li class="menu-item {{$title == 'payout'?'active':''}}">
        <a href="{{route('payout')}}" class="menu-link">
            <i class="fa-solid fa-dollar-sign fa-lg me-2"></i>
    ...
    <li class="menu-item {{$title == 'payment'?'active':''}}">
        <a href="{{route('payment')}}" class="menu-link">
            <i class="fa-solid fa-hand-holding-dollar fa-lg me-2"></i>
    ...
    ">
      ...
      <ul class="menu-sub">
        ...
        @can('clear_cache')
        <li class="menu-item">
            <a href="{{ route('sitemap.reload') }}" class="menu-link  text-white bg-gray">
               <div data-i18n="Sitemap Reload">Sitemap Reload</div>
           </a>
       </li>
        <li class="menu-item">
             <a href="{{ route('clear.cache') }}" class="menu-link  text-white bg-danger">
    ...
    @endcan
    @can('todo_list')
        <li class="menu-item {{$title == 'todoList'?'active':''}}">
            <a href="{{route('todo.list')}}" class="menu-link">
                <i class="fa-solid fa-clipboard-list fa-lg me-2"></i>
                <div data-i18n="Todo List">Todo List</div>
            </a>
        </li>
    @endcan
        ...
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <!-- Points -->
                        <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                            <a class="text-white nav-link dropdown-toggle hide-arrow doller" style="cursor: pointer" href="{{route('pending.list')}}">
                                <i class="fa-solid fa-hourglass-half"></i>
                                {{ App\Models\MovieModel::where('status', 0)->where('approval', null)->get()->count() }}
                            </a>
                        </li>
                    <!--/ Points -->
                    @endcan
                    ...
                    <!-- Points -->
                    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                        <a class="text-white nav-link dropdown-toggle hide-arrow doller" style="cursor: pointer" href="{{route('rejected.list')}}">
                            <i class="fa-solid fa-ban"></i>
                            {{ App\Models\MovieModel::where('user_id', Auth::user()->id)->where('approval', 0)->get()->count() }}
                        </a>
                    </li>
                    <!--/ Points -->
                    @endcan
