...
<body id="body" class="t33" style="min-width:100%;Margin:0px;padding:0px;background-color:#F0F0F0;">
    <div class="t32" style="background-color:#F0F0F0;">
...
<table role="presentation" cellpadding="0" cellspacing="0" align="center" valign="top" width="600"><tr><td width="600" valign="top"><![endif]-->
                                                <div class="t27"
                                                    ...
                                                    <table role="presentation" width="100%" cellpadding="0"
                                                        cellspacing="0" class="t26" style="width:100%!important;">
                                                        <tr>
                                                            <td class="t25">
...
<![endif]-->
                                                                                    ...
                                                                                    <td class="t2"
                                                                                        ...
                                                                                        <div style="font-size:0px;">
                                                                                            <img class="t0"
                                                                                                ...
                                                                                                height="59.015625"
                                                                                                alt=""
                                                                                                src="https://28c7cd74-700a-42a1-adcb-09fb348523c6.b-cdn.net/e/ccce2c74-de76-4ece-bf7f-18a19d4c885d/5e260929-69b9-465d-aeba-ceea6c750e1e.png" />
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="t5"
                                                                                style="mso-line-height-rule:exactly;mso-line-height-alt:80px;line-height:80px;font-size:1px;display:block;">
                                                                                &nbsp;&nbsp;</div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
...
<![endif]-->
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="t14"
                                                                                style="mso-line-height-rule:exactly;mso-line-height-alt:65px;line-height:65px;font-size:1px;display:block;">
                                                                                &nbsp;&nbsp;</div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="t16" role="presentation"
                                                                                ...
                                                                                <tr>
                                                                                    <!--[if mso]>
<td width="308" class="t15" style="background-color:#0055FF;overflow:hidden;text-align:center;line-height:58px;mso-line-height-rule:exactly;mso-text-raise:11px;border-radius:14px 14px 14px 14px;">
<![endif]-->
                                                                                    <!--[if !mso]>-->
                                                                                    <td class="t15"
                                                                                        style="background-color:#0055FF;overflow:hidden;width:308px;text-align:center;line-height:58px;mso-line-height-rule:exactly;mso-text-raise:11px;border-radius:14px 14px 14px 14px;">
                                                                                        <!--<![endif]-->
                                                                                        <p class="t13"
                                                                                            style="display:block;margin:0;Margin:0;font-family:Fira Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:58px;font-weight:600;font-style:normal;font-size:21px;text-decoration:none;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:11px;"
                                                                                            target="_blank">{{ $code }}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="t24" role="presentation"
                                                                                cellpadding="0" cellspacing="0"
                                                                                style="Margin-left:auto;Margin-right:auto;">
                                                                                <tr>
                                                                                    <!--[if mso]>
<td width="350" class="t23" style="overflow:hidden;border-radius:41px 41px 41px 41px;">
<![endif]-->
                                                                                    <!--[if !mso]>-->
                                                                                    <td class="t23"
                                                                                        style="overflow:hidden;width:350px;border-radius:41px 41px 41px 41px;">
                                                                                        <!--<![endif]-->
                                                                                        <p class="t21"
                                                                                            style="margin:0;Margin:0;font-family:Fira Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:30px;font-weight:500;font-style:normal;font-size:15px;text-decoration:none;text-transform:capitalize;direction:ltr;color:#666666;text-align:center;mso-line-height-rule:exactly;mso-text-raise:5px;">
                                                                                            Didn&#39;t request
                                                                                            this?<span class="t20"
                                                                                                style="margin:0;Margin:0;mso-line-height-rule:exactly;">
                                                                                                <a class="t19"
                                                                                                    href="https://cinenest.net/contact"
                                                                                                    style="margin:0;Margin:0;font-weight:700;font-style:normal;text-decoration:none;text-transform:capitalize;direction:ltr;color:blue;mso-line-height-rule:exactly;"
                                                                                                    target="_blank"><span
                                                                                                        class="t18"
                                                                                                        style="margin:0;Margin:0;color:#0004FF;mso-line-height-rule:exactly;">Let
                                                                                                        us
                                                                                                        know</span></a>.</span>
                                                                                        </p>
                                                                                    </td>
...
<![endif]-->
    ...
    <style type="text/css">
        @media (min-width: 481px) {[class~="x_t29"] {
            width:600px !important;
        }
