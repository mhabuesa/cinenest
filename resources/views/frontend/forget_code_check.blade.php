			...
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- authorization form -->
						<form action="{{route('forgetCodeCheck',$id)}}" class="sign__form" method="POST">
                            @csrf
							...
							<div class="sign__group">
								<input type="text" name="code" class="sign__input" placeholder="Code" required>
                                @if(session('error'))
							...
							<span class="sign__text">Code Sent to your email !!</span>
