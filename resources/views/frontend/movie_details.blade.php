        ...
        <div class="row">
                        ...
                        <div class="col-12 col-md-8 col-lg-9 col-xl-7">
                            <div class="card__content">
                                <ul class="card__meta">
                                    ...
                                    <li class="mb-4"><span>Country:</span> {{$movie->country}}</li>
                                    <li style="padding: 3px 7px; border:1px solid #EFA501; border-radius:5px; display:inline; margin-top:5px"><span>Download:</span> {{$download}}</li>
                                </ul>
            ...
            <div class="col-12 col-xl-6 col-sm-12">
                <div class="card--details">
                    ...
                    <div class="card__content" style="justify-content: center; align-items: center;">
                        <iframe style="width: 100%; height: 325px;" src="https://www.youtube.com/embed/{{$movie->trailer}}?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    <!-- end card content -->
                </div>
            </div>
                    ...
                    <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="1-tab">
                        ...
                        <div class="gallery" itemscope>
                            <div class="row row--grid">
                                ...
                                @foreach ($screenShortLinks as $ss )
                                <!-- gallery item -->
                                <figure class="col-6 col-sm-6 col-xl-6" itemprop="associatedMedia" itemscope>
                                        <img loading="lazy" src="{{$ss->link}}" itemprop="thumbnail" alt="Image description" />
                                </figure>
                        ...
                        <div class="col-12 mb_5 down_text">
                            <!-- content title -->
