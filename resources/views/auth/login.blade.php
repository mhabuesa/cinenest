...
<head>
    ...
    <title>Login | CineNest – Online Movies Website</title>
      ...
      <div class="card" style="background-color: #a3a3a3;">
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center mb-4 mt-2">
            <img src="{{asset('frontend')}}/img/logo.png" width="120" alt="">
          </div>
          <!-- /Logo -->
          <h4 class="mb-1 pt-2">Welcome to CIneNest!</h4>
...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Nov 2023 15:03:23 GMT -->
</html>
