...
<head>
    ...
    <title>Not Authorized - Pages | CineNest.net</title>
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <div class="mt-4">
      <img src="{{asset('backend')}}/img/illustrations/page-misc-you-are-not-authorized.png" alt="page-misc-not-authorized" width="170" class="img-fluid">
    </div>
  </div>
</div>
<div class="container-fluid misc-bg-wrapper">
  <img src="{{asset('backend')}}/img/illustrations/bg-shape-image-light.png" alt="page-misc-not-authorized" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.html">
</div>
<!-- /Not Authorized -->
