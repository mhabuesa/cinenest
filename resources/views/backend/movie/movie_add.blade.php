            ...
            <form action="{{route('movie.store')}}" class="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="row row--form">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input type="text" class="form-control" name="trailer" placeholder="Trailer Link" id="trailer" value="{{old('trailer')}}">
                    </div>

                    {{-- <div class="col-12 mt-3">
                        <label for="caption">Screen Short Link</label>
                        <div id="ssContainer">
                            <div class="d-flex justify-content-between mt-1">
                                <input type="text" class="form-control mx-1" name="screen_short_link[]" placeholder="Add Image link">
                                <a class="btn btn-success mx-1 btn-sm" id="addSs"><i class="fa-solid fa-plus text-white"></i></a>
                            </div>
                        </div>
                        @error('ss')
                    ...
                    <div class="col-12 mt-3">
                        <label for="caption">Screen Short</label>
