            ...
            <table id="example" class="display table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            @can('movie_edit')
                            <a class="btn btn-primary m-1" href="{{route('movie.edit',$movie->id)}}"> <i class="fa-solid fa-pencil" style="color: #ffff;"></i></a>
                            @endcan

                            @can('movie_delete')
                            <a class="btn btn-primary m-1" data-bs-toggle="modal" data-bs-target="#movie_delete{{$movie->id}}"> <i class="fa-solid fa-trash" style="color: #ff0000;"></i> </a>
                            @endcan
                        </td>
                    </tr>
