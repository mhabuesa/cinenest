                ...
                <div class="card-body table-responsive">
                    ...
                    @foreach ($activities as $key=> $activity )
                        <tr class="text-capitalize">
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen_{{$activity->user->id}}">View</button>
                            </td>
                        </tr>
                        <div class="modal fade" id="exampleModalFullscreen_{{$activity->user->id}}" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" style="display: none;" aria-hidden="true">
